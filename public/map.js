...
const URL_PREFIX = "http://localhost:8080" + APP_NAME;//"http://47.75.79.142:8080" + APP_NAME;
...
const NANTONG_FILE = "/data/nantong.txt"
const BRONX_FILE="/data/BusJson.txt"
...
let mapv_option_line_light_purple = {
    strokeStyle: 'rgba(245,61,190,0.7)',
    //coordType: 'bd09mc',
    //globalCompositeOperation: 'lighter',
    shadowColor: 'rgba(53,57,255,0.6)',
    shadowBlur: 3,
    lineWidth: 3.0,
    draw: 'simple'
};
let mapv_bus_line_light_green = {
